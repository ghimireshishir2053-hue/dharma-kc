              ...
              <form onSubmit={submit}>
                <div
                  style={{
                    ...
                    background: "rgba(95,186,137,0.10)",
                    border: "1px solid rgba(95,186,137,0.30)",
                    color: "var(--ink-dim)", fontSize: 13, lineHeight: 1.4,
                  }}
                >
                  <span style={{ color: "#5FBA89", flexShrink: 0, display: "flex" }}>
